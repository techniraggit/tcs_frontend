          ...
          <div class="filter-wrap custom-datepicker">
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DatePicker inputFormat="YYYY-MM-DD" // 13-09-2022
                label="From Date" value={props.fromDate} onChange={(newValue) => props.setFromDate(newValue)} />
              <DatePicker inputFormat="YYYY-MM-DD" // 13-09-2022
                label="To Date" value={props.toDate} onChange={(newValue) => props.setToDate(newValue)} />
